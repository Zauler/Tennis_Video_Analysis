...
from court_line_detector import CourLineDetector
...
def main():
    ...
    cout_model_path = "models/keypoints_model.pth"
    court_line_detector = CourLineDetector(cout_model_path)
    ...
    for ball_shot_ind in range(len(ball_shot_frames)-1):
        ...
        ball_shot_time_in_seconds = (end_frame-start_frame)/24 #fps
        
        # Get distance coverd by the ball
        ...
        distance_covered_by_ball_meters = convert_pixel_distance_to_meteres(distance_covered_by_ball_pixels, 
        ...
        distance_covered_by_opponent_meters = convert_pixel_distance_to_meteres(distance_covered_by_opponent_pixels, 
                                                                          constants.DOUBLE_LINE_WIDTH, 
                                                                          mini_court.get_width_of_mini_court()
                                                                          )
    ...
    ##Draw ball Bounding Boxis
    output_video_frames  = ball_tracker.draw_bboxes(video_frames, ball_detections)
    ## Draw court Keypoints 
    output_video_frames = court_line_detector.draw_keypints_on_video(video_frames, court_keypoints)
